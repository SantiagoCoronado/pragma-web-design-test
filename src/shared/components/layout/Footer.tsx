...
import { MarqueeText } from "@/shared/components/motion/MarqueeText";
...
export function Footer() {
  ...
  const tickerItems = t.raw("tickerItems") as string[];

  return (
    <footer className="bg-pragma-bg">
      <MarqueeText items={tickerItems} />
